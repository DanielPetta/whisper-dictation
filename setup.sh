...
echo "  9. Add action: 'Run Shell Script'"
echo "     osascript -e 'tell application \"System Events\" to keystroke (the clipboard)'"
...
echo ""
echo "  See README.md for detailed step-by-step instructions with troubleshooting."
echo ""
