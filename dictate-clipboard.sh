...
# Whisper Dictation — Clipboard Mode
# Transcribes speech and copies to clipboard (for use with Apple Intelligence in Shortcuts)
...
PID_FILE=/tmp/dictate_clipboard_pid
...
stop_and_transcribe() {
    ...
    # Copy to clipboard instead of typing — Shortcuts will handle the rest
    echo -n "$TEXT" | pbcopy
